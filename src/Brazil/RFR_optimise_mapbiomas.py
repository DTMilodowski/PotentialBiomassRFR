...
param_space = { "max_depth":scope.int(hp.quniform("max_depth",20,400,1)),              # ***maximum number of branching levels within each tree
                    ...
                    "min_samples_leaf":scope.int(hp.quniform("min_samples_leaf",2,15,1)),    # ***The minimum number of samples required to be at a leaf node
...
algorithm = partial(tpe.suggest, n_startup_jobs=spin_up, gamma=0.15, n_EI_candidates=50)
